...
from config import DECAY, LEARNING_RATE, NUM_CLASSES, LSTM_HIDDEN_CHANNELS, \
    NUM_SENSOR_CHANNELS, CONV_HIDDEN_CHANNELS, DROP_RATE, EPOCHS, FILTER_SIZE, BATCH_SIZE
